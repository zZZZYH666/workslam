...
public:
    ...
    unsigned long GetSemanticLoopCandidates() const { return mnSemanticLoopCandidates; }
    unsigned long GetSemanticLoopMatches() const { return mnSemanticLoopMatches; }
    unsigned long GetSemanticLoopTrustedInliers() const { return mnSemanticLoopTrustedInliers; }
    unsigned long GetSemanticLoopProvisionalInliers() const { return mnSemanticLoopProvisionalInliers; }
...
protected:
    ...
    unsigned long mnSemanticLoopCandidates = 0;
    unsigned long mnSemanticLoopMatches = 0;
    unsigned long mnSemanticLoopTrustedInliers = 0;
    unsigned long mnSemanticLoopProvisionalInliers = 0;
