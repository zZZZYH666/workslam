...
class KeyFrame
{
    ...
    void serialize(Archive& ar, const unsigned int version)
    {
        ...
        ar & const_cast<vector<unsigned char>&>(mvSemanticSource);
        ar & const_cast<vector<float>&>(mvSemanticWeight);
        ...
        ar & const_cast<vector<unsigned char>&>(mvSemanticSourceRight);
        ar & const_cast<vector<float>&>(mvSemanticWeightRight);
        ar & mGridRight;
...
public:
    ...
    const std::vector<unsigned char> mvSemanticSource;
    const std::vector<float> mvSemanticWeight;
    const std::vector<unsigned char> mvSemanticSourceRight;
    const std::vector<float> mvSemanticWeightRight;
