...
namespace ORB_SLAM3 {
    ...
    struct SemanticPromotionConfig {
        int minVisibleFrames = 5;
        int minKeyFrames = 2;
        float minMatchRatio = 0.60f;
        float maxReprojectionError = 2.0f;
        float minStaticRatio = 0.70f;
        int maxAgeKeyFrames = 8;
        int maxDynamicObservations = 2;
    };

    struct SemanticConfig {
        bool enableFallback = false;
        int targetFeatures = 1000;
        int minStaticFeatures = 300;
        int minStereoMatches = 80;
        int minTrackingInliers = 50;
        float minGridCoverage = 0.15f;
        float maxFallbackRatio = 0.5f;
        bool enableMapPointPromotion = false;
        int promotionMinVisibleFrames = 5;
        int promotionMinKeyFrames = 2;
        float promotionMinMatchRatio = 0.60f;
        float promotionMaxReprojectionError = 2.0f;
        float promotionMinStaticRatio = 0.70f;
        int provisionalMaxAgeKeyFrames = 8;
        int provisionalMaxDynamicObservations = 2;
        bool enableGeometricPromotion = false;
        int geometricPromotionMinVisibleFrames = 8;
        int geometricPromotionMinKeyFrames = 3;
        float geometricPromotionMinMatchRatio = 0.70f;
        float geometricPromotionMaxReprojectionError = 1.5f;
        int geometricPromotionMaxDynamicObservations = 0;
        bool enableProvisionalLoopSupport = false;
        int provisionalLoopMinVisibleFrames = 5;
        int provisionalLoopMinKeyFrames = 2;
        float provisionalLoopMinMatchRatio = 0.60f;
        int provisionalLoopMaxAgeKeyFrames = 8;
        int provisionalLoopMaxDynamicObservations = 0;
        int provisionalLoopMinTrustedInliers = 15;
        float provisionalLoopMaxFraction = 0.30f;
        bool enableSoftSelection = false;
        ...
        SemanticPromotionConfig promotionConfig() const {
            ...
            c.minVisibleFrames = promotionMinVisibleFrames;
            c.minKeyFrames = promotionMinKeyFrames;
            c.minMatchRatio = promotionMinMatchRatio;
            c.maxReprojectionError = promotionMaxReprojectionError;
            c.minStaticRatio = promotionMinStaticRatio;
            c.maxAgeKeyFrames = provisionalMaxAgeKeyFrames;
            c.maxDynamicObservations = provisionalMaxDynamicObservations;
            return c;
        }

        SemanticPromotionConfig loopConfig() const {
            SemanticPromotionConfig c;
            c.minVisibleFrames = provisionalLoopMinVisibleFrames;
            c.minKeyFrames = provisionalLoopMinKeyFrames;
            c.minMatchRatio = provisionalLoopMinMatchRatio;
            c.maxAgeKeyFrames = provisionalLoopMaxAgeKeyFrames;
            c.maxDynamicObservations = provisionalLoopMaxDynamicObservations;
            c.maxReprojectionError = promotionMaxReprojectionError;
            c.minStaticRatio = 0.0f;
            return c;
        }

        SemanticPromotionConfig geometricPromotionConfig() const {
            SemanticPromotionConfig c;
            c.minVisibleFrames = geometricPromotionMinVisibleFrames;
            c.minKeyFrames = geometricPromotionMinKeyFrames;
            c.minMatchRatio = geometricPromotionMinMatchRatio;
            c.maxReprojectionError = geometricPromotionMaxReprojectionError;
            c.minStaticRatio = 0.0f;
            c.maxAgeKeyFrames = provisionalMaxAgeKeyFrames;
            c.maxDynamicObservations = geometricPromotionMaxDynamicObservations;
            return c;
        }
    };
    ...
    public:
        ...
        const SemanticConfig& semanticConfig() const {return semanticConfig_;}
    ...
    private:
        ...
        void readSemantic(cv::FileStorage& fSettings);
         ...
         */
        float thFarPoints_;
        SemanticConfig semanticConfig_;
