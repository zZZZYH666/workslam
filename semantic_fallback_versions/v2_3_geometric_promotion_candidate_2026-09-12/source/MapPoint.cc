...
{
    p->mSemanticState = static_cast<int>(SemanticMapPointState::STATIC);
    p->mnSemanticVisibleFrames = 0;
    p->mnSemanticMatchedFrames = 0;
    p->mnSemanticConsecutiveVisibleFrames = 0;
    p->mnSemanticStaticObservations = 0;
    p->mnSemanticUnknownObservations = 0;
...
SemanticMapPointState MapPoint::GetSemanticState() const
{
    return static_cast<SemanticMapPointState>(mSemanticState);
}

bool MapPoint::IsProvisional() const { return mSemanticState == static_cast<int>(SemanticMapPointState::PROVISIONAL); }
bool MapPoint::IsPromoted() const { return mSemanticState == static_cast<int>(SemanticMapPointState::PROMOTED); }

void MapPoint::SetSemanticState(SemanticMapPointState state) { mSemanticState = static_cast<int>(state); }

void MapPoint::Promote(const std::string &reason)
{
    if(IsProvisional())
    {
...
{ return mnSemanticVisibleFrames > 0 ? static_cast<float>(mnSemanticMatchedFrames) / mnSemanticVisibleFrames : 0.0f; }
float MapPoint::SemanticStaticRatio() const
{
    const int total = mnSemanticStaticObservations + mnSemanticUnknownObservations;
...
bool MapPoint::ShouldReject(const SemanticPromotionConfig &config) const
{
