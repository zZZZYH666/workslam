...
public:
    ...
    // Counts before semantic filtering, retained for experiment diagnostics.
    int mnRawLeftFeatures = 0;
    int mnRawRightFeatures = 0;
    int mnStaticLeftFeatures = 0;
    int mnStaticRightFeatures = 0;
    int mnFallbackLeftFeatures = 0;
    int mnFallbackRightFeatures = 0;
    int mnStereoMatches = 0;
    int mnTrackingInliers = 0;
    float mfLeftGridCoverage = 0.0f;
    ...
    std::vector<unsigned char> mvSemanticSource, mvSemanticSourceRight;
    std::vector<float> mvSemanticWeight, mvSemanticWeightRight;
